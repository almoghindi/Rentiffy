...
function createData(name, views, entries, deals, revenues) {
  return { name, views, entries, deals, revenues };
}
              ...
              <Table sx={{ minWidth: 1200 }} aria-label="customized table">
                <TableHead>
                  <TableRow>
                    ...
                    <StyledTableCell align="center">חשיפות</StyledTableCell>
                    <StyledTableCell align="center">כניסות </StyledTableCell>
                    <StyledTableCell align="center">עסקאות </StyledTableCell>
                    <StyledTableCell align="center">סך הכנסות </StyledTableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {rows.map((row) => (
